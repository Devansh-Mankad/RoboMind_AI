...
def main():
    ...
    # Case 4 can disagree because a strong crack signal raises Bayesian evidence while weight remains normal.
    # Case 8 can disagree because tilt is strong evidence but both weight and crack readings look normal.
